	...
	function validate_dateI(){
		const fecha = new Date().toISOString();
		var fechaI = document.getElementById("diaI");
		fechaI.setAttribute("min", fecha.substring(0, fecha.length - 8));
	}

	function validate_dateF(){
		var fechaI = document.getElementById("diaI");
		var fechaF = document.getElementById("diaF");
		fechaF.setAttribute("min",fechaI.value);
	}